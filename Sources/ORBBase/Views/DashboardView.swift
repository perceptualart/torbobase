...
// Main dashboard — dark, gorgeous, the ORB at the center of everything
import SwiftUI
...
struct HomeView: View {
    ...
    var body: some View {
        ...
        ScrollView {
            VStack(spacing: 20) {
                // The ORB — hero with rainbow slider
                OrbAccessView(
    ...
    private var pairingContent: some View {
        if pairing.pairingActive {
            VStack(spacing: 12) {
                ...
                Text("Enter in ORB app → Settings → ORB Base")
                    .font(.system(size: 10))
                    .foregroundStyle(.white.opacity(0.3))
...
struct SettingsView: View {
    ...
    private let systemPromptPresets: [(String, String)] = [
        ...
        ("ORB", "You are ORB, an AI assistant created by Perceptual Art. You are running on a local ORB Base gateway. Be helpful, knowledgeable, and respect the user's privacy."),
    ]
    ...
    var body: some View {
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 24) {
                ...
                Text("Optional — for routing to cloud models through ORB Base")
                    .font(.system(size: 11))
                    .foregroundStyle(.white.opacity(0.3))
        ...
        VStack(spacing: 0) {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    Or use the Models tab in ORB Base to pull directly.
                    """)

                    // Step 3
                    installStep(number: 3, title: "Connect ORB", content: """
                    ORB Base automatically detects Ollama and your models.

                    1. Make sure Ollama is running (check menu bar)
                    2. ORB Base will show "Ollama ●" in the sidebar
