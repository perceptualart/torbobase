...
enum SetupStep: Int, CaseIterable {
    ...
    var title: String {
        switch self {
        case .welcome: return "Welcome to ORB Base"
    ...
    static var userStepCount: Int { 5 }
...
struct SetupWizardView: View {
    ...
    private var welcomeStep: some View {
        VStack(spacing: 24) {
            ...
            Text("5 quick steps — takes about 2 minutes")
                ...
                VStack(spacing: 0) {
                    ...
                    if showAPIKeyInfo {
                        VStack(alignment: .leading, spacing: 8) {
                            infoRow(
                                q: "What is it?",
                                a: "A secret password that lets ORB Base talk to cloud AI services on your behalf. Each provider gives you one on their website."
                            )
                            infoRow(
    ...
    private var readyStep: some View {
        VStack(spacing: 20) {
            ...
            VStack(spacing: 8) {
                ...
                VStack(spacing: 4) {
                    Text("Open this URL on any Mac, PC, phone, or tablet on your network:")
                        .font(.system(size: 10))
                        .foregroundStyle(.white.opacity(0.3))
