...
struct TelegramConfig: Codable {
    ...
    static var stored: TelegramConfig {
        get {
            ...
            let chatId = defaults.string(forKey: "orbTelegramChatId") ?? ""
            let enabled = defaults.bool(forKey: "orbTelegramEnabled")
        ...
        set {
            let defaults = UserDefaults.standard
            defaults.set(newValue.chatId, forKey: "orbTelegramChatId")
            defaults.set(newValue.enabled, forKey: "orbTelegramEnabled")
...
enum AppConfig {
    ...
    static var accessLevel: Int {
        get { defaults.integer(forKey: "orbAccessLevel") }
        set { defaults.set(newValue, forKey: "orbAccessLevel") }
    }

    static var serverPort: UInt16 {
        get {
            let v = UInt16(defaults.integer(forKey: "orbServerPort"))
            return v == 0 ? 4200 : v
        }
        set { defaults.set(Int(newValue), forKey: "orbServerPort") }
    }
    ...
    static var sandboxPaths: [String] {
        get {
            defaults.stringArray(forKey: "orbSandboxPaths") ?? [
                "~/Desktop", "~/Documents", "~/Downloads"
            ]
        }
        set { defaults.set(newValue, forKey: "orbSandboxPaths") }
    }

    static var rateLimit: Int {
        get {
            let v = defaults.integer(forKey: "orbRateLimit")
            return v == 0 ? 60 : v
        }
        set { defaults.set(newValue, forKey: "orbRateLimit") }
    }

    static var setupCompleted: Bool {
        get { defaults.bool(forKey: "orbSetupCompleted") }
        set { defaults.set(newValue, forKey: "orbSetupCompleted") }
    }
    ...
    static var systemPrompt: String {
        get { defaults.string(forKey: "orbSystemPrompt") ?? "" }
        set { defaults.set(newValue, forKey: "orbSystemPrompt") }
    }

    static var systemPromptEnabled: Bool {
        get { defaults.bool(forKey: "orbSystemPromptEnabled") }
        set { defaults.set(newValue, forKey: "orbSystemPromptEnabled") }
    }
