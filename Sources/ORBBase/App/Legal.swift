...
enum Legal {
    ...
    static let eulaAcceptedKey = "orbEULAAccepted"
    static let eulaVersionKey = "orbEULAVersion"
    ...
    static let eulaText = """
    ORB BASE — END USER LICENSE AGREEMENT
    ...
    to use ORB Base on devices you own or control.
    ...
    Full EULA and Privacy Policy: https://orbbase.ai/legal

    © 2026 Perceptual Art LLC. All rights reserved.
    """

    static let privacySummary = """
    ORB Base collects ZERO data. No telemetry, no analytics, no crash reports, \
    ...
    See EULA and Privacy Policy at https://orbbase.ai/legal
    """
}
