...
actor DMGBuilder {
    ...
    static let toolDefinition: [String: Any] = [
        ...
        "function": [
            "name": "build_dmg",
            "description": "Build a complete DMG installer for ORB Base. Runs the build.sh script which compiles, signs, and packages the app into a distributable DMG. Includes automatic versioning from git tags.",
            "parameters": [
                "type": "object",
    ...
    private let projectPath = NSString(string: "~/Documents/orb master/orb base").expandingTildeInPath
    private let buildScriptPath = NSString(string: "~/Documents/orb master/orb base/build.sh").expandingTildeInPath
    ...
    func buildDMG() async -> String {
        ...
        do {
            ...
            if process.terminationStatus == 0 {
                ...
                let dmgName = "ORBBase-\(version).dmg"
    ...
    private func fallbackBuild(version: String) async -> String {
        ...
        do {
            ...
            // Find the ORBBase binary
            let binaryName = "ORBBase"
            ...
            result += "   The binary is ready at: .build/release/ORBBase"
