...
actor ScreenCapture {
    ...
    static let toolDefinition: [String: Any] = [
        ...
        "function": [
            "name": "capture_screen",
            "description": "Capture a screenshot of the entire screen and save it to /tmp/orb_screen.png. Returns the path to the captured image.",
            "parameters": [
                "type": "object",
    ...
    func captureScreen() async -> String {
        let outputPath = "/tmp/orb_screen.png"
